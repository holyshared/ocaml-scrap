...
(* OASIS_START *)
(* DO NOT EDIT (digest: e9636670ca1012470fc7e7779dc3a0db) *)
(*
...
let setup_t =
  {
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "functor"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {exec_custom = false; exec_main_is = "example_functor.ml"})
            ];
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "Q\187\176*\196\222s\155\220\172\131\001\166}\200'";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
