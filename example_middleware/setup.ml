...
(* OASIS_START *)
(* DO NOT EDIT (digest: 37b64a93819445bb6951fcd955b3d6c5) *)
(*
...
let setup_t =
  {
            ...
            [
               Executable
                 ({
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "example_middleware.ml"
                   });
               Library
                 ({
                     cs_name = "example_middleware";
                   ...
                   {
                      lib_modules = ["Middleware"; "Context"; "Logger"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "example_middleware";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "example_middleware"
                        ];
                      bs_build_tools =
                   ...
                   {exec_custom = false; exec_main_is = "all_test.ml"});
               Test
                 ({
                     cs_name = "test";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "\021c\134\1346b\0120h\154=\138,G\023\144";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
