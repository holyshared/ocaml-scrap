...
(* OASIS_START *)
(* DO NOT EDIT (digest: a5cba93a84204ef12780a22dfd94bc77) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Formatter"; "Logger"; "File_logger"];
                      lib_pack = false;
               ...
               Executable
                 ({
                     cs_name = "example_first_class_module";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "logger"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "example_first_class_module.ml"
                   })
            ];
     ...
     oasis_version = "0.4.8";
     oasis_digest =
       Some "s\028\133\179\137\225\2177\164\181\129\214_C\160\237";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
