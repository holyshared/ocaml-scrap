...
(* OASIS_START *)
(* DO NOT EDIT (digest: ff122c51214e66973e0d58e837a2bf50) *)
(*
...
let setup_t =
  {
            ...
            [
               Executable
                 ({
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "example_string_map.ml"
                   });
               Executable
                 ({
                     cs_name = "example_int_map";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "example_int_map.ml"})
            ];
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\015\235\156|XN\\I@\249\170;\134\182\140\\";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
