...
(* OASIS_START *)
(* DO NOT EDIT (digest: 632788e6ecdfbd2f5b258872a3f4eb53) *)
(*
...
let setup_t =
  {
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [FindlibPackage ("process", None)];
                   ...
                   {exec_custom = false; exec_main_is = "example_process.ml"})
            ];
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "\225L\237\248\\\006\170\163b\248\193+A\212\021\158";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
