...
(* OASIS_START *)
(* DO NOT EDIT (digest: ca1a588bcaf1a1f4dc807f1541a8a2f5) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Env"; "Env_config"; "Env_variable"];
                      lib_pack = false;
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [InternalLibrary "example_variant_type"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {exec_custom = false; exec_main_is = "variant_type.ml"})
            ];
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "7\197\023N\194\224X\000\r\193\224\012\233 \203H";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
