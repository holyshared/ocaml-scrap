...
(* OASIS_START *)
(* DO NOT EDIT (digest: 137ab61d17b8b46d4db9644fad782eb7) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src/task";
                      bs_compiled_object = Native;
                      bs_build_depends = [InternalLibrary "log"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Native;
                      bs_build_depends =
                        [InternalLibrary "log"; InternalLibrary "task"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {
                      lib_modules =
                        ["App"; "Cli_usage"; "Cli"; "Command"; "Sub_command1"
                        ];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "example_main.ml"})
            ];
     ...
     oasis_digest = Some "\223\165\242\002\153S\003vw4\163\243eHT\180";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
