...
(* OASIS_START *)
(* DO NOT EDIT (digest: 790695c372789a2abe3fe7fde4524761) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "tests";
                      bs_compiled_object = Best;
                      bs_build_depends = [FindlibPackage ("git.unix", None)];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "lib_git"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {exec_custom = false; exec_main_is = "example_git.ml"});
               Executable
                 ({
                     cs_name = "test";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "lib_git";
                           FindlibPackage ("oUnit", None);
                           InternalLibrary "lib_git_test"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\164\200P\251\211\024\146\2275e?,g\207\153\213";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
