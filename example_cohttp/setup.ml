...
(* OASIS_START *)
(* DO NOT EDIT (digest: 32cc5da055c7105be58531ca665d1788) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Github"; "Github_t"; "Github_j"];
                      lib_pack = false;
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "github"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {exec_custom = false; exec_main_is = "example_cohttp.ml"})
            ];
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "*\016ba\134\201\026\185\165\179\246\1823|\151\151";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
