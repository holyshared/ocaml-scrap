...
(* OASIS_START *)
(* DO NOT EDIT (digest: f847295d50f5492656a2275c406c3e34) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          maintainers = [];
          authors =
            ["Noritaka Horio <holy.shared.design@gmail.com>\227\128\128"];
          homepage = None;
          bugreports = None;
          synopsis = "example";
          description = None;
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "\241a\214\198\211\231\160\196fQ\176W\184\177\244A";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
