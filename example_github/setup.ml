...
(* OASIS_START *)
(* DO NOT EDIT (digest: d430a3a65bf56f36ef0cf692e7ce7523) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("github.unix", None);
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ugithub.ml"})
            ];
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\178\154\015\1933\187\r\192\026u\247\r\206\159G1";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
