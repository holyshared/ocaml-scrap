...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7f0b0369a6f003bb157a2a15c5449def) *)
(*
...
let setup_t =
  {
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "example_cache.ml"});
               Library
                 ({
                     cs_name = "example_cache";
                     cs_data = PropList.Data.create ();
                   ...
                   {
                      lib_modules = ["Cache_manager"; "Source_file"; "Lines"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "example_cache";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "example_test.ml"});
               Test
                 ({
                     cs_name = "test";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "\011R\192\154YY\158K\146g[\167\203\221\031\159";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
