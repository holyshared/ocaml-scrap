...
(* OASIS_START *)
(* DO NOT EDIT (digest: e18f75a106162fbe20010e8b8a86a092) *)
(*
...
let setup_t =
  {
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "tcp_header"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "example_tcp_header.ml"
                   })
            ];
     ...
     oasis_digest = Some "Ac\165^\152W=-j\027\232K\240a\202\144";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
