...
(* OASIS_START *)
(* DO NOT EDIT (digest: baea5d45ad60da8024ae37e49c9f251e) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          sections =
            [
               ...
               Executable
                 ({
                     cs_name = "example_lwt_command_basic";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "example_basic.ml"});
               Executable
                 ({
                     cs_name = "example_lwt_command_stream";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("lwt.unix", None);
                           InternalLibrary "lwt_command_stream"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                   ...
                   {exec_custom = false; exec_main_is = "example_stream.ml"})
            ];
     ...
     oasis_digest = Some "Q\024\209\011\127n(\"\178\179Wd\220\190\168X";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
