...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5c581f872feae0fb99ffef22ad7b1b2a) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "example_lwt_command.ml"
                   })
            ];
     ...
     oasis_digest = Some "\172\1958\248\219\189r\220\235O\158\220A\012FH";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
